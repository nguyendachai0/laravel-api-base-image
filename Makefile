...
push:  ## Push to prod image
	docker tag prod-laravel-api-base-image:latest 637423634020.dkr.ecr.ap-southeast-1.amazonaws.com/prod-laravel-api-base-image:latest
	docker push 637423634020.dkr.ecr.ap-southeast-1.amazonaws.com/prod-laravel-api-base-image:latest